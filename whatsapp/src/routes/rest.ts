...
export function createRestRouter(pool: Pool, sessionManager: SessionManager): Router {
    ...
    // POST /api/news/subscribe - Subscribe to daily news digest
    ...
    // POST /api/news/unsubscribe - Unsubscribe from daily news digest
    ...
    // GET /api/news/subscription-status - Get current subscription status
